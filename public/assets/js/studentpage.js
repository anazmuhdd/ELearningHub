document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    if (studentResponse.ok) {
      ...
      document.getElementById("student-enrollment-date").textContent =
        student.date_of_birth; // Assuming this is the enrollment date
      ...
      if (enrollmentsResponse.ok) {
        ...
        console.error(
          ...
          enrollments.message || "Unknown error"
        );
      }
